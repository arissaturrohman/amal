            ...
            <div class="card-header">
              <div class="row">
                <div class="col-sm">
                  ...
                  <a href="#" class="btn btn-outline-success btn-sm float-sm-right"><i class="fa fa-print"></i> Cetak</a>
                </div>
              </div>
            </div>
            <!-- /.card-header -->
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                        ...
                        <a onclick="return confirm('Apakah Anda Yakin Menhgapus Data Ini..?')" href="?page=masuk&aksi=hapus&id=<?php echo $data['id']; ?>" type="button" class="btn btn-danger" title="hapus"><i class="fas fa-trash-alt"></i></a>
                      </div>
                  </td>
                </tr>
